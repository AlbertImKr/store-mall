...
public class CreatedProductResponse extends RepresentationModel<CreatedProductResponse> {
    ...
    @Builder
    private CreatedProductResponse(ProductId productId, String productName, Money price,
            String description,
